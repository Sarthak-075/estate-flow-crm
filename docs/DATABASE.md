...
_The `properties` view aggregates data from `projects`, `buildings`, and `units` to provide a uniform API for searching and displaying assets._
...
_All definitions are ready to be placed under `/docs/DATABASE.md`._
